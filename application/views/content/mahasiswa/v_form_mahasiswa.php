	...
	<div class="card-body">
		<form id="form-tambah-mhs" enctype="multipart/form-data" method="post" action="<?= site_url("mahasiswa/proses_simpan") ?>">
			<div class="form-group">
				...
				<input required type="text" value="<?= $this->session->userdata('nim') ?>"  name="nim" id="nim" class="form-control" readonly />
			</div>
			<div class="form-group">
				<label for="">Nama Mahasiswa</label>
				<input required type="text" value="<?= $this->session->userdata('nama') ?>"  name="nama" id="nama" class="form-control" />
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<textarea required type="text" value="<?= $this->session->userdata('alamat') ?>"  name="alamat" id="alamat" class="form-control"></textarea>
			</div>
			<div class="form-group">
				<label for="">Tanggal Lahir</label>
				<input required type="date" value="<?= $this->session->userdata('tgl') ?>" name="tgl_lahir" id="tgl_lahir" class="form-control" />
			</div>
			<div class="form-group">
				<label for="">IPK</label>
