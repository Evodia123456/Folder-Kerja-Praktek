	...
	<form class="form-horizontal">
		<?php if ($this->session->userdata('idMhs')) { ?>
			<div class="form-group row">
				...
				<div class="col-sm-10">
					<input type="email" class="form-control" id="inputName" placeholder="<?= $this->session->userdata('nim'); ?>" readonly>
				</div>
			</div>
		<?php } ?>
		<div class="form-group row">
			...
			<div class="col-sm-10">
				<input type="email" class="form-control" id="inputEmail" placeholder="<?= $this->session->userdata('nama'); ?>">
				<!-- //readonly> -->
			</div>
		</div>
