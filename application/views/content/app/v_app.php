<div class="row">
	<div class="col-md-4">
		<div class="card">
			<div class="card-header"><h5>Pilih Perolehan</h5></div>
			<div class="card-body">
				<div class="form-group">
					<label for="">Pilih Perolehan</label>
					<select name="" class="form-control" id="select-perolehan">
						<option value="" disabled selected>Pilih Perolehan</option>
						<?php
						foreach ($transaksis as $b) {
							echo "<option data-nama='$b->nama_perolehan' "
								. "data-poin='$b->poin' "
								// . "data-stock='$b->stock_barang' "
								. "data-tingkat='$b->tingkat_iid' "
								. "value='$b->id_perolehan'> "
								. "$b->tingkat_id / $b->nama_perolehan"
								. "</option>";
						}
						?>
					</select>
